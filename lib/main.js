...
class Tester {
  ...
  */
  ...
  createStatusBar(statusBar/* : Object*/) {
    ...
    statusBarTile.resetResults = function () {
  ...
  decorateGutter(editor/* :TextEditor*/, gutter/* :Gutter*/, messages/* : Array<Object>*/) {
    ...
    messages.forEach((message) => {
      const tooltipDuration = $(document.createElement('div')).text(message.duration);
      const tooltipTesterName = $(document.createElement('div')).text('Tester');
      const tooltipTitle = $(document.createElement('div')).append(tooltipDuration, tooltipTesterName, message.title);
      const tooltipError = $(document.createElement('div')).text(message.error);
      const tooltip = $(document.createElement('div')).append(tooltipTitle, tooltipError);
      const item = $(document.createElement('span')).addClass(`tester-gutter tester-highlight ${message.state}`);
