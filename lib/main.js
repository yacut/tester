...
class Tester {
  ...
  */
  ...
  createStatusBar(statusBar/* : Object*/) {
    ...
    passedTestsSpan.className = 'tester-bottom-status tester-status-passed highlight';
    const failedTestsSpan = document.createElement('span');
    failedTestsSpan.textContent = '0';
    failedTestsSpan.className = 'tester-bottom-status tester-status-failed highlight';
    const skippedTestsSpan = document.createElement('span');
    skippedTestsSpan.textContent = '0';
    skippedTestsSpan.className = 'tester-bottom-status tester-status-skipped highlight';
    const statusTiny = document.createElement('span');
    statusTiny.textContent = '';
    statusTiny.className = 'tester-bottom-status tester-tiny loading loading-spinner-tiny highlight';
