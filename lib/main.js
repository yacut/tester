...
class Tester {
  ...
  */
  ...
  createStatusBar(statusBar/* : Object*/) {
    ...
    statusTiny.className = 'tester-bottom-status tester-tiny loading loading-spinner-tiny';
    ...
    statusBarTile.testRunning = function () {
      ...
      statusTiny.className = 'tester-bottom-status tester-tiny icon icon-check';
    };
