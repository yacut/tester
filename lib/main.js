  ...
  constructor(initialState) {
    ...
    this.deserializeResultView = function deserializeResultView() {
      ...
      resultView.onCurrentFileOnlyClick((currentFileOnly: boolean) => {
        console.log('currentFileOnly', currentFileOnly);
        self.getStore().dispatch(filterMessagesAction(currentFileOnly));
      });
    ...
    this.commands.onShouldTestProject(() => {
      self.getStore().dispatch(testProjectAction(self.resultView ? self.resultView.getAdditionalArgs() : ''));
    });
