...
class Tester {
  ...
  constructor() {
    ...
    this.deserializeConsoleOutput = function deserializeConsoleOutput(serializedState :any) {
      console.log('serializedState', serializedState.toString());
  ...
  createStatusBar(statusBar : Object) {
    ...
    this.statusBarTile = new StatusBarTile({ store: this.getStore(), onclick });
...
export default {
  ...
  initialize(rawState: any) {
    console.log('rawState', rawState.toString());
