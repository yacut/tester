...
class Tester {
  ...
  constructor(state : State) {
    ...
    this.commands.onShouldTest(this.test);
  ...
  async test(shouldTestCurrentProject :?boolean) {
    console.log('onShouldTest', shouldTestCurrentProject);
    console.log('active editor', atom.workspace.getActiveTextEditor());
