...
import type { Store, TesterSorter } from './types';
...
class Tester {
  ...
  constructor(initialState) {
    ...
    this.deserializeResultView = function deserializeResultView() {
      ...
      resultView.onTestButtonClick((additionalArgs: string) => {
    ...
    this.commands.onShouldTestProject(() => {
      self.getStore().dispatch(testProjectAction(self.resultView ? self.resultView.getAdditionalArgs() : null));
    });
    this.commands.onShouldTest(() => {
      self.getStore().dispatch(testAction(self.resultView ? self.resultView.getAdditionalArgs() : null));
    });
