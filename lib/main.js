...
class Tester {
  ...
  */
  ...
  constructor(state/* : State*/) {
    ...
    this.registryTesters.onDidUpdateMessages(({ editor, messages, output }) => {
      ...
      if (this.showInlineError) {
        setInlineMessages(editor, messages, this.ansiToHtml);
      }
  ...
  setOutput(editor/* : TextEditor*/, output/* :string*/) {
    OutputViewManager.getView().setContent(output, this.ansiToHtml).finish(this.showOutputAfterTestRun, this.messageTimeout);
  }
