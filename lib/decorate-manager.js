...
export function decorateGutter(editor :TextEditor, gutter :Gutter, messages : Array<Object>) {
  ...
  forEach(messages, (message) => {
    ...
    if (message.state === 'passed') {
      ...
      tooltipTesterState.addClass('highlight-info');
    }
    const tooltip = $(document.createElement('span'))
      .append(tooltipTesterName, tooltipTesterState, tooltipDuration)
      .addClass('inline-block tester-tooltip-title');
