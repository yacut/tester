...
export const SET_RESULT_VIEW_COLUMNS = 'tester/setResultViewColumns';
...
export function setResultViewColumns(
  resultViewColumns :{
    columns: Array<Column>;
    columnWidthRatios: WidthMap;
  }): TesterAction {
  return {
    type: SET_RESULT_VIEW_COLUMNS,
    payload: { resultViewColumns },
  };
}
