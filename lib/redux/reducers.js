...
export default function (
  ...
  switch (action.type) {
    ...
    case SET_RESULT_VIEW_COLUMNS:
      if (action.payload &&
        action.payload.resultViewColumns &&
        action.payload.resultViewColumns.columns &&
        action.payload.resultViewColumns.columnWidthRatios) {
        return Object.assign({}, state, {
          resultViewColumns: action.payload.resultViewColumns,
        });
      }
      return state;
