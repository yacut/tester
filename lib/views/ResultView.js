      ...
      <div class='tester-output-view'>
        ...
        <div class='tester-messages' ref='messages' messages={this.properties.messages}>
          <div class='tester-messager-header inline-block'>
              <div class='tester-message-cell tester-message-state-head inline-block'>State</div>
              <div class='tester-message-cell tester-message-duration-head inline-block'>Duration</div>
              <div class='tester-message-cell tester-message-title-head inline-block'>Title</div>
              <div class='tester-message-cell tester-message-location-head inline-block pull-right'>Location</div>
          </div>
