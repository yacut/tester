        ...
        <div class='tester-messages' ref='messages' messages={this.properties.messages}>
          {this.properties.messages.map((message) => {
            ...
            return <div class="tester-message-row inline-block">
                    ...
                    <div class="tester-message-title">
                      <pre>{message.title}</pre>
                    </div>
                    <span class="tester-message-state highlight-info">{message.state}</span>
                    <div class="tester-message-filepath">{message.filePath}</div>
                    <div class="tester-message-linenumber">{message.lineNumber}</div>
                    <div class="tester-message-duration">{message.duration}</div>
              </div>;
          })}
        </div>
      </div>
