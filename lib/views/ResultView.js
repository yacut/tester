      ...
      <div class='tester-view'>
        ...
        <div class='tester-toolbar inline-block'>
          ...
          <div class='inline-block pull-right'>
            ...
            <atom-text-editor mini gutter-hidden class='atom-text-editor-sm mini inline-block-tight input-text'
               style='width: 250px; line-height: 1.3em;' ref='additionalArgs' placeholder='Additional args (not saved in settings)'>
            </atom-text-editor>
