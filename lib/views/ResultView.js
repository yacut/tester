          ...
          {messages.map((message, index) =>
            <div class='tester-message-row inline-block'
              ...
              onclick={this.handleRowClick.bind(this, index)}>
                    <div class={
                      stateStyle === 'Icon' ?
                      'tester-message-cell tester-message-state-icon inline-block' :
                      ...
                      <span class={
                        ...
                        'unknown'}>
                          {stateStyle === 'Icon' ?
                            message.state === 'failed' ? <span class='icon icon-x'></span> :
                            message.state === 'skipped' ? <span class='icon icon-dash'></span> :
                            message.state === 'passed' ? <span class='icon icon-check'></span> :
