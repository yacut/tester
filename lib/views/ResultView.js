...
export default class ResultView {
      ...
      <div class='tester-view'>
        ...
        <div class='tester-toolbar inline-block'>
          ...
          <div class='inline-block pull-right'>
            ...
            <input class='input-text inline-block-tight' ref='additionalArgs' type='text' style='width: 200px;' placeholder='Additional args'></input>
  ...
  handleTestButtonClick():void {
    ...
    this.emitter.emit('test-project-button-click', this.refs.additionalArgs.textContent);
  }
