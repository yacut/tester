      ...
      <div class='tester-output-view'>
        ...
        <div class="tester-toolbar inline-block">
          ...
          <div class="inline-block pull-right">
            <label class='input-label'><input class='input-checkbox' type='checkbox'/> Wrap words</label>
            <label class='input-label'><input class='input-checkbox' type='checkbox'/> Current file only</label>
          </div>
        </div>
