...
export default class ResultView {
      ...
      <div class='tester-view'>
        ...
        <div class='tester-toolbar inline-block'>
          ...
          <div class='inline-block pull-right'>
            ...
            <atom-text-editor class='atom-text-editor-sm inline-block-tight editor mini' tabindex="0" mini
              ref='additionalArgs' placeholder='Additional args (not saved in settings)' style='width: 250px; line-height: 1.3em;'></atom-text-editor>
  ...
  handleTestButtonClick():void {
    console.log('ref', this.refs.additionalArgs.value);
    this.emitter.emit('test-project-button-click', this.refs.additionalArgs.value);
  }
