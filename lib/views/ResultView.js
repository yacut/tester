      ...
      <div class='tester-output-view'>
        ...
        <div class="tester-toolbar inline-block">
          ...
          <div class="inline-block pull-right">
            ...
            <button class="inline-block btn btn-sm" title="Test File" onclick={this.properties.testTrigger.bind(this, false)}>Test File</button>
            <button class="inline-block btn btn-sm" title="Test Project" onclick={this.properties.testTrigger.bind(this, true)}>Test Project</button>
          </div>
        </div>
