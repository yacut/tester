...
import { Emitter, CompositeDisposable, Disposable, TextEditor, TextBuffer } from 'atom';
...
export default class ResultView {
  ...
  desc: boolean;
  currentTest: Message;
  additionalArgsBuffer: TextBuffer;

  constructor(properties:Object) {
    this.properties = properties;
    this.emitter = new Emitter();
    this.disposables = new CompositeDisposable();
    const additionalArgs = this.properties.state ? this.properties.state.additionalArgs : '';
    this.additionalArgsBuffer = new TextBuffer({ text: additionalArgs });
          ...
          <div class='inline-block pull-right'>
            ...
            <div class='inline-block-tight' style='width: 200px; font-size: 0.8em;'>
              {etch.dom(TextEditor, {
                ...
                buffer: this.additionalArgsBuffer,
              })}
            </div>
  ...
  update(newState :TesterState, shouldUpdate :?boolean) {
    if (newState && this.properties.state !== newState) {
      ...
      this.additionalArgsBuffer.setText(this.properties.state.additionalArgs);
