      ...
      <div class='tester-view'>
        ...
        <div class='tester-toolbar inline-block'>
          ...
          <div class='inline-block pull-right'>
            ...
            <input class='inline-block-tight input-text' type='text' style='width: 250px; line-height: 1.3em;'
              ref='additionalArgs' placeholder='Additional args (not saved in settings)'/>
