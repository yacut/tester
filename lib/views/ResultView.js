...
export default class ResultView {
      ...
      <div class='tester-output-view'>
        ...
        <div class="tester-toolbar inline-block">
          ...
          <div class="inline-block pull-right">
            <label class='input-label inline-block-tight'><input class='input-checkbox' type='checkbox'/> Soft Wrap</label>
            <label class='input-label inline-block-tight'><input class='input-checkbox' type='checkbox'/> Current file only</label>
            <button class="inline-block btn btn-sm" title="Test File" onclick={this.handleTestButtonClick.bind(this, false)}>Test File</button>
            <button class="inline-block btn btn-sm" title="Test Project" onclick={this.handleTestButtonClick.bind(this, true)}>Test Project</button>
          </div>
        </div>
  ...
  handleTestButtonClick(shouldTestCurrentProject :boolean):void {
    ...
    this.emitter.emit('test-button-click');
  }
}
