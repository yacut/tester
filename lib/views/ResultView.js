...
export default class ResultView {
  ...
  constructor(properties: {
    ...
    this.refs.additionalArgs.element.addEventListener('onChange', (event) => {
      console.log('event', event);
      this.emitter.emit('set-additional-args', event.target.value);
    });
    this.disposables.add(new Disposable(() => { this.refs.additionalArgs.element.removeEventListener('onChange', softWrapHandler()); }));
  }
