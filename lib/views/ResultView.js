...
export default class ResultView {
  ...
  constructor(properties:Object) {
    ...
    const softWrapHandler = () => {
      ...
      this.properties.softWrap = this.refs.softWrap.isChecked;
      this.update(this.properties);
    };
    this.refs.softWrap.addEventListener('click', softWrapHandler);
    this.disposables.add(new Disposable(() => { this.refs.closeButton.removeEventListener('click', softWrapHandler()); }));
  }
