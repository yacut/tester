...
export default class ResultView {
  ...
  constructor(properties:Object) {
    ...
    this.refs.currentFileOnly.addEventListener('click', currentFileOnlyHandler);
        ...
        <div class='tester-toolbar inline-block'>
          ...
          <div class='inline-block pull-right'>
            <label class='input-label inline-block-tight'>
              <input class='input-checkbox' ref='currentFileOnly' type='checkbox' checked={this.properties.currentFileOnly}/> Current file only</label>
            <label class='input-label inline-block-tight'>
