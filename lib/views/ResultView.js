      ...
      <div class='tester-output-view'>
        ...
        <div class='tester-messages' ref='messages' messages={this.properties.messages}>
          <div class='tester-message-header inline-block'>
              <div class='tester-message-cell tester-header highlight tester-message-state inline-block'>State</div>
              <div class='tester-message-cell tester-header highlight tester-message-duration inline-block'>Duration</div>
              <div class='tester-message-cell tester-header highlight tester-message-title inline-block'>Title</div>
              <div class='tester-message-cell tester-header highlight tester-message-location inline-block'>Location</div>
          </div>
          ...
          {this.properties.messages.map((message) => {
            ...
            return <div class='tester-message-row inline-block'>
                    ...
                    <div class='tester-message-cell tester-message-location inline-block'>
