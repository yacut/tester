    ...
    return (
      <div class='tester-output-view'>
        ...
        <div class='tester-messages' ref='messages' messages={this.properties.messages}>
          <div class='tester-messager-header inline-block'>
              <div class='tester-message-cell tester-message-state inline-block'>State</div>
              <div class='tester-message-cell tester-message-duration inline-block'>Duration</div>
              <div class='tester-message-cell tester-message-title inline-block'>Title</div>
              <div class='tester-message-cell tester-message-location inline-block pull-right'>Location</div>
          </div>

          {() => {
            if (!this.properties.messages || this.properties.messages.length === 0) {
              return <div class='tester-empty-container'>No tester messages</div>;
            }
          }}
          {this.properties.messages.map((message) => {
            ...
            return <div class='tester-message-row inline-block'>
                    ...
                    <div class='tester-message-cell tester-message-location inline-block pull-right'>
                      {message.filePath || ''}:{message.lineNumber || 0}
                    </div>
              </div>;
          })}
        </div>
