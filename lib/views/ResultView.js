...
export default class ResultView {
  ...
  constructor(properties: {
    ...
    this.columns = [
      { title: 'State', key: 'state', width: 0.05 },
      { title: 'Duration', key: 'duration', width: 0.05 },
      { title: 'Title', key: 'title', width: 0.25 },
      { title: 'Error', key: 'error', width: 0.5 },
      { title: 'Location', key: 'location', width: 0.15 },
    ];
    this.columnWidthRatios = this._getInitialWidthsForColumns(this.columns);
    console.log('this.columnWidthRatios', this);
        ...
        <div class='tester-messages' ref='messages' messages={messages}>
          <div class='tester-message-header inline-block'>
              <div class={
                ...
                <span class="tester-header-resizer" onMouseDown={this._handleResizerMouseDown.bind(this, 'state')}></span>
              </div>
              <div class='tester-message-cell tester-header tester-message-duration inline-block'
                ...
                <span class="tester-header-resizer" onMouseDown={this._handleResizerMouseDown.bind(this, 'duration')}></span>
              </div>
              <div class='tester-message-cell tester-header tester-message-title inline-block'
                ...
                <span class="tester-header-resizer" onMouseDown={this._handleResizerMouseDown.bind(this, 'title')}></span>
              </div>
              <div class='tester-message-cell tester-header tester-message-error inline-block'
                ...
                <span class="tester-header-resizer" onMouseDown={this._handleResizerMouseDown.bind(this, 'error')}></span>
              </div>
              <div class='tester-message-cell tester-header tester-message-location inline-block'
                ...
                <span class="tester-header-resizer" onMouseDown={this._handleResizerMouseDown.bind(this, 'location')}></span>
              </div>
          </div>
  ...
  _handleResizerMouseDown(key: ColumnKey, event: any): void {
    console.log('_handleResizerMouseDown', this);
  ...
  // Prevent browser from initiating drag events on accidentally selected elements.
    ...
    this._tableWidth = this.refs.messages.getBoundingClientRect().width;
  ...
  _handleResizerGlobalMouseUp(event: any): void {
    console.log('event', event);
    this._unsubscribeFromGlobalEvents();
  }

  _handleResizerGlobalMouseMove(event: any): void {
    if (
      this._resizeStartX == null ||
      this._tableWidth == null ||
      this._columnBeingResized == null
    ...
    const currentColumnSize = this.columnWidthRatios[this._columnBeingResized];
  ...
  _updateWidths(resizedColumn: string, newColumnSize: number): boolean {
    ...
    console.log('columnWidthRatios', this.columnWidthRatios);
    return true;
  }
